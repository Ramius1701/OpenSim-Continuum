...
| Experiences | Robust service extension | Create/associate an experience, grant and revoke permission, relog, restart region and Robust, exercise parcel/estate controls and KVP persistence, and verify denied permissions remain denied. | MySQL and Robust are the supported production target; HG experience trust must remain local. SQLite/PGSQL service providers are not certified. |
